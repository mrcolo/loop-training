...
\begin{axis}[
  ...
  ylabel={loss},
  xmin=0, xmax=8200, ymin=0.79, ymax=0.94,
  tick label style={font=\scriptsize},
  label style={font=\scriptsize},
...
(500,0.8672)(890,0.8612)(1270,0.8580)(1660,0.8428)(2040,0.8456)(2430,0.8402)
(2810,0.8384)(3190,0.8357)(3570,0.8242)(3960,0.8191)(4340,0.8084)(4730,0.8211)
(5110,0.8147)(5500,0.8188)(5880,0.8134)(6270,0.8177)(6650,0.8267)(7040,0.8329)
(7420,0.8266)(7810,0.8219)(8000,0.8233)
};
\addlegendentry{generation loss (smoothed)}
\addplot[ctx,very thick] coordinates {
(1200,0.9188)(1550,0.9154)(1900,0.9129)(2250,0.9104)(2600,0.9085)(2950,0.9076)
(3300,0.9060)(3650,0.9052)(4000,0.9044)(4350,0.9039)(4700,0.9045)(5050,0.9034)
(5400,0.9024)(5750,0.9004)(6100,0.8992)(6450,0.8989)(6800,0.8983)(7150,0.8983)
(7500,0.8971)(7850,0.8956)(8000,0.8948)
};
\addlegendentry{validation loss, frozen slice}
\end{axis}
\end{tikzpicture}
\caption{\textbf{Both curves descend for the whole run.} Neither indicates when to
stop, and neither would have revealed the failure of \S\ref{sec:checkpoint}. The
frozen slice is the more legible of the two only because it holds excerpts, masks,
timesteps and noise fixed; a single training batch at a random timestep spans
$0.71$--$0.92$ at any point in the run.}
\label{fig:curves}
\end{figure}
...
\bottomrule
\end{tabular}
\caption{The frozen slice descends monotonically over the whole run, including
across the interval in which sample quality stopped improving
(\S\ref{sec:final}).}
\label{tab:val}
\end{table}
